...
public static class MemorySegmentDefaults
{
    public static MemorySegmentDefault Get(MemorySegment segment)
    {
        return segment switch
        {
            ...
            MemorySegment.AgentIdentity => new MemorySegmentDefault(MemoryTier.Permanent, 0.8, 0.85, 0.012),
            ...
            MemorySegment.AgentRelationship => new MemorySegmentDefault(MemoryTier.Long, 0.7, 0.8, 0.025),
            MemorySegment.Preference => new MemorySegmentDefault(MemoryTier.Long, 0.7, 0.85, 0.02),
            MemorySegment.AgentPreference => new MemorySegmentDefault(MemoryTier.Long, 0.65, 0.8, 0.025),
