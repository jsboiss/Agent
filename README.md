...
- `src/Agent`: Blazor Server application with the dashboard, dispatcher contracts, memory placeholders, chat channels, and Claude boundary organized as folders.
